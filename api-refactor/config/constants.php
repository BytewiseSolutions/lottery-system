...
define('ACTION_ADMIN_VOTE_CREATE', 'admin_vote_create');
define('ACTION_ADMIN_VOTE_UPDATE', 'admin_vote_update');
define('ACTION_ADMIN_VOTE_DELETE', 'admin_vote_delete');
define('ACTION_DRAW_CREATE', 'draw_create');
define('ACTION_DRAW_CLOSE', 'draw_close');
define('ACTION_RESULT_CREATE', 'result_create');
define('ACTION_RESULT_UPDATE', 'result_update');
define('ACTION_RESULT_PUBLISH', 'result_publish');
define('ACTION_WINNER_CLAIM', 'winner_claim');
define('ACTION_PAYMENT_PROCESS', 'payment_process');
define('ACTION_NOTIFICATION_CREATE', 'notification_create');
define('ACTION_SETTINGS_UPDATE', 'settings_update');
